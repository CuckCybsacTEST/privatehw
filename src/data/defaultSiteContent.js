...
export const defaultSiteContent = {
  topBarDesktop: 'Solo para miembros verificados y respetuosos',
  topBarDesktopHighlight: 'miembros verificados y respetuosos',
  topBarMobile: 'Perfil verificado para miembros adultos con acceso restringido',
  ...
  presencialBenefitTitle: 'Suscriptores verificados de Loverfans:',
  presencialBenefitText: 'precio especial S/120 x hora (20% OFF)',
  ...
  videoLibrary: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Placeholder final del bloque extendido para validar catálogos largos desde home y detalle.',
        tag: 'Drop 15',
        duration: '09:03',
        priceLabel: 'S/63',
        accessLabel: 'Acceso completo',
        previewLabel: 'Preview corto disponible',
        posterImage: 'img/teaser11.jpg',
        previewVideoUrl: '',
        fullVideoUrl: '',
        purchaseUrl: 'https://loverfans.com/sindyhotwife',
      },
    ...
    items: [
      {
        ...
        highlights: ['Full HD', 'Preview incluido', 'Acceso instantaneo'],
      ...
      },
      {
        ...
        category: 'Weekend drop',
        title: 'Weekend Collection',
        description:
          'Card para category drops recurrentes con precio especial y narrativa visual propia.',
        itemCount: '4 videos',
        priceLabel: 'S/99',
        accessLabel: 'Bundle temporal',
        highlights: ['Mini previews', 'Entrega inmediata', 'Upsell para membership'],
      ...
      },
      {
        ...
        category: 'Archive edits',
        title: 'Archive Edits Pack',
        description:
      ...
      },
      {
        ...
        category: 'Launch bundle',
        title: 'Launch Bundle Pack',
        description:
          'Coleccion adicional para presentar drops de temporada, bundles de entrada y agrupaciones por tema.',
        itemCount: '5 videos',
        priceLabel: 'S/129',
      ...
      },
      {
        ...
        category: 'Member favorites',
        title: 'Member Favorites Pack',
        description:
      ...
      },
      {
        ...
        category: 'Curator drop',
        title: 'Curator Drop 01',
        description:
      ...
      },
      {
        ...
        category: 'Seasonal',
        title: 'Seasonal Pack 03',
        description:
          'Placeholder adicional para escenarios de temporada, campañas y bundles rotativos.',
        itemCount: '4 videos',
        priceLabel: 'S/109',
      ...
      },
      {
        ...
        category: 'Signature',
        title: 'Signature Pack 06',
        description:
          'Placeholder pensado para sostener una libreria más grande de packs y rutas de descubrimiento.',
        itemCount: '5 videos',
        priceLabel: 'S/129',
        accessLabel: 'Acceso premium',
      ...
      },
      {
        ...
        category: 'Archive',
        title: 'Archive Pack 07',
        description:
          'Pack mock para incrementar el inventario visible y reforzar la página completa de categorías.',
        itemCount: '9 videos',
        priceLabel: 'S/179',
      ...
      },
      {
        ...
        title: 'Weekly Drop Pack 08',
        description:
          'Coleccion placeholder orientada a validar futuras estrategias de actualización frecuente.',
        itemCount: '6 videos',
        priceLabel: 'S/136',
        accessLabel: 'Drop semanal',
        highlights: ['Preview corto', 'Pack flexible', 'Ideal para campañas'],
        coverImage: 'img/teaser4.jpg',
        previewUrl: 'https://loverfans.com/sindyhotwife',
        purchaseUrl: 'https://loverfans.com/sindyhotwife',
      },
      {
        ...
        title: 'Extended Library Pack 09',
        description:
          'Placeholder final para dejar una base amplia de packs y categorías lista para pruebas reales.',
        itemCount: '10 videos',
        priceLabel: 'S/209',
  ...
  membership: {
    ...
    planItems: [
      'Acceso a drops premium',
      'Prioridad en novedades del catalogo',
      'Bloque preparado para perks, bundles y descuentos',
    ],
    ...
    sideCards: [
      ...
      },
      {
        ...
        description:
          'Espacio para agrupar fotos, videos y productos por categorias o campañas.',
      },
    ],
  },
  blogSection: {
